...
from src.fitParameters.fit_structures import MSE, random_walk_clusters
...
if __name__=="__main__":
    ...
    initial_guess = random_walk_clusters(initial_guess, num_of_training_steps, training_grids)
    print("final: ", initial_guess, MSE(initial_guess, training_grids))

    with open("../../resources/random_walk_parameters_clusters.json", "w") as file:
